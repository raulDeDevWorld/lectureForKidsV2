...
export default function BottomNavigation({ rol }) {
    ...
    return <div className={`fixed w-screen left-0 bottom-0 w-screen grid h-[70px] lg:hidden grid-cols-3  bg-gradient-to-tr from-[#00195c] via-[#274492] to-[#00195c] border-t-[5px] border-white mx-auto font-medium z-50`}>
        ...
        <Button click={() => redirectHandlerWindow(`https://sistemas.logisticsgear.net`)} name={'Productos'}>
            ...
            <svg className="w-11 h-11 mb-1" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="text-[12px] text-white   ">My LG</span>
        </Button>
        ...
        <Button click={() => redirectHandler(`/#Home`)} name={'Cliente'}>
            <svg className="w-11 h-11 mb-1 text-gray-600 redrounded-full  " fill="white" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
